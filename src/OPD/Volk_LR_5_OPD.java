...
public class Volk_LR_5_OPD {
    ...
    static void VasRUN(double[][] per,Scanner sc){
        ...
        System.out.print("\n___________________________________________________________________________________________________________");
        System.out.print("\n[4] Среднеквадратичное отклонение для оценки суммарной трудоемкости кодирования составит: "+dF.format(TMP4)+" (чел * час)");
        TMP5 = TMP3+2*TMP4;
        System.out.print("\n___________________________________________________________________________________________________________");
        ...
        TMP10 = TMP9/TMP8;
        System.out.print("\n___________________________________________________________________________________________________________");
        System.out.print("\n[10] Средняя численность команды: "+TMP10+" (чел)");
        System.out.println("\n_________________________________________________КОНЕЦ_____________________________________________________\n\n");
    };
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            System.out.println("1. Произвести расчет");
            System.out.println("9. Изменить трудозатраты программистов");
            ...
            if (tmp == 0){
                System.out.println("___________________________________________ЗАВЕРШЕНИЕ ПРОГРАММЫ____________________________________________");
                break;
            } else if (tmp == 9) {
